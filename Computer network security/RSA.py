...
if r == 1:
   ...
   print(
       "Multiplicative inverse for the given encryption key does not exist. Choose a different encryption key "
   )
...
# and product n.
M1 = (S**e) % n
print("Message generated by Bob using Alice's public key(M1): " + str(M1))
...
if M == M1:
   ...
   print("As M is not equal to M1, Do not accept the message sent by Alice ")